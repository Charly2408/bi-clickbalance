...
CREATE PROCEDURE `proc_crea_dimension_territorio`(IN flag bit(1), IN baseDatosProd varchar(50), IN baseDatosBI varchar(50))
/* 
Autor: Carlos Audelo
...
BEGIN
	...
	IF flag = 0 THEN 
		...
		SET @qDelete = CONCAT("DROP TABLE IF EXISTS ", baseDatosBI,".territorio;");
