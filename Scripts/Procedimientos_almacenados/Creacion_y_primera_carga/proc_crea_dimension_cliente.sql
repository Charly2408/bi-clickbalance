...
CREATE PROCEDURE `proc_crea_dimension_cliente`(IN flag bit(1), IN idEmpresa integer, IN baseDatosProd varchar(50), IN baseDatosBI varchar(50), IN fechaTiempoETL DATETIME)
/*  
Autor: Carlos Audelo
...
BEGIN
	...
	SET @query = CONCAT("INSERT INTO ",baseDatosBI,".cliente(cliente_nk, nombre_cliente, estado_civil, regimen, 
        ...
        WHERE es_cliente = 1 and empresa = ", idEmpresa," AND created_at <= '", fechaTiempoETL, "';");
